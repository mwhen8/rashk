...
app = Client('::memory::', in_memory=True, api_hash='a1ca0b577d1d9a68e34996e166df5269', api_id=25802886, lang_code="ar", bot_token=w['give_bot_token'])
...
async def generate_session(app, message):
    ...
    msg = message
    api_id = 25802886
    api_hash = "a1ca0b577d1d9a68e34996e166df5269"
...
async def clear(app, call):
    ...
    for session in sessions:
        ...
        phon = session['phone']
        try:
            client = temp('::memory::', api_id=25802886, api_hash='a1ca0b577d1d9a68e34996e166df5269', in_memory=True, session_string=sessio)
